    ...
    products.forEach((ele) => {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-outline-success m-2 edit-btn" id="${ele.id}">Edit</button>
                <button class="btn btn-outline-danger m-2 delete-btn" id="${ele.id}">Delete</button>
                </div>
            </div>
        </div>
    </div>
...
async function onEditProduct(e) {
    try {
        ...
        productFormElements.id.value = id,
...
async function refresh() {
    try {
        ...
        showOutput(response.data.products)
    } catch (error) {
        alert(error.response.data.message);
        window.location = '/';
    }
